        ...
        <div className="col-sm-12 ">
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-1">
                <button type="button" className="btn btn-secondary" style={{ background:"#39064fff " }} onClick={addDistributionField}>
                  + Add Subject
                </button>
              </div>
              <button type="submit" className="btn btn-light text-white  mt-1 w-50" style={{ background: "#39064fff" , width:"200px" }}>
                {isEditing ? 'Update Exam' : 'Create'}
              </button>
            </form>
          </div>
        </div>
